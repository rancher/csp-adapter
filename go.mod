...
replace (
	github.com/rancher/rancher/pkg/apis => github.com/rancher/rancher/pkg/apis v0.0.0-20250514134529-bea4ce32ba61
...
require (
	...
	github.com/rancher/wrangler/v3 v3.2.1-rc.5 // indirect
